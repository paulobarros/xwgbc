...
# {{< fa triangle-exclamation >}} Disclaimer {background-color="white" background-image="images/bg1.png" background-size="contain" background-repeat="no-repeat"}
...
***Bokermannohyla capra*** {{< fa caret-right>}} Esforço reprodutivo (Gessica Ramos)
